...
namespace OrderyAPI.Utils
{
    public abstract class Constants
    {
        ...
        //sequence table
        public static string GETSEQUENCE = "SELECT province_code, year, sequence, db_name FROM sequence_table INNER JOIN province USING (id) WHERE province.id=@params0";
        //user specifics
        ...
        public static string CREATEUSERLOGIN = "INSERT INTO user_login (username, salt, password, tbl) VALUES (params0, params1, params2)";
